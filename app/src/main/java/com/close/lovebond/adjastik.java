...
public class adjastik extends Application {
    ...
    private void instFlyer() {
        ...
        AppsFlyerLib.getInstance().init("8mKgWgts5gmAa5bR6jZiJD", conversionListener, this); //todo вставить ключ апса
